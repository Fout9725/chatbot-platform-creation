...
const Oferta = () => {
  ...
  return (
    <PageLayout
      ...
      description="Публичная оферта на использование платформы ИнтеллектПро"
      keywords="публичная оферта, договор, ИнтеллектПро"
    >
      <div className="relative container mx-auto px-4 py-8 glass-fade-in">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <GlassCard className="p-8 md:p-12 space-y-6 text-[15px] leading-[1.7]">
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">1. Термины и определения</h2>
              <ul className="list-disc list-inside pl-2 space-y-2 text-gray-200">
                <li><strong className="text-white">Исполнитель</strong> — Индивидуальный предприниматель Дмитриева Ольга Анатольевна,
                ИНН 263504091920, ОГРН 318565800079487</li>
                <li><strong className="text-white">Заказчик</strong> — физическое или юридическое лицо, принявшее условия настоящей оферты</li>
                <li><strong className="text-white">Платформа</strong> — программное обеспечение ИнтеллектПро, доступное по адресу в сети Интернет</li>
                <li><strong className="text-white">Услуги</strong> — предоставление доступа к функционалу Платформы согласно выбранному тарифу</li>
                <li><strong className="text-white">Акцепт</strong> — полное и безоговорочное принятие условий оферты путем регистрации и оплаты</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">2. Предмет договора</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">3. Стоимость услуг и порядок оплаты</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">4. Права и обязанности Исполнителя</h2>
              <h3 className="text-xl font-semibold mb-2 text-white">4.1. Исполнитель обязуется:</h3>
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">4.2. Исполнитель имеет право:</h3>
              <ul className="list-disc list-inside pl-2 space-y-2 text-gray-200">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">5. Права и обязанности Заказчика</h2>
              <h3 className="text-xl font-semibold mb-2 text-white">5.1. Заказчик обязуется:</h3>
              <ul className="list-disc list-inside pl-2 space-y-2 text-gray-200 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">5.2. Заказчик имеет право:</h3>
              <ul className="list-disc list-inside pl-2 space-y-2 text-gray-200">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">6. Ответственность сторон</h2>
              <p className="text-gray-200 leading-relaxed">
              ...
              <ul className="list-disc list-inside pl-2 space-y-2 text-gray-200 mb-4 mt-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">7. Возврат денежных средств</h2>
              <p className="text-gray-200 leading-relaxed">
              ...
              <p className="text-gray-200 leading-relaxed mt-3">
                7.2. Для возврата необходимо направить заявление на адрес{' '}
                <a
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">8. Конфиденциальность</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">9. Форс-мажор</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">10. Срок действия и расторжение договора</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">11. Разрешение споров</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-white">12. Заключительные положения</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section className="bg-white/5 border border-white/10 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-white">Реквизиты Исполнителя</h3>
              <p className="text-gray-200">
                <strong className="text-white">Индивидуальный предприниматель Дмитриева Ольга Анатольевна</strong><br />
                ИНН: 263504091920<br />
              ...
              <p className="text-gray-200 mt-4">
                <strong className="text-white">Банковские реквизиты:</strong><br />
