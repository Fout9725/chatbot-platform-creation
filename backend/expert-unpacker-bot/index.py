...
QUESTIONS = {
    1: "Как вас зовут?",
    2: "Чем вы занимаетесь? Опишите вашу деятельность в 2-3 предложениях.",
    3: "Сколько лет вы работаете в этой сфере?",
    4: "Какая у вас ключевая экспертиза? В чём вы разбираетесь лучше всего?",
    5: "Кто ваша целевая аудитория? Опишите вашего идеального клиента.",
    6: "Какую главную проблему вы решаете для своих клиентов?",
    7: "Какие результаты получают ваши клиенты после работы с вами?",
    8: "Чем вы отличаетесь от других специалистов в вашей нише?",
    9: "Какой у вас самый яркий кейс или история успеха клиента?",
    10: "Какие у вас есть регалии, сертификаты, образование по теме?",
    11: "Какие ценности лежат в основе вашей работы?",
    12: "Есть ли у вас собственная методика или авторский подход?",
    13: "Какой контент вы уже создаёте? (блог, соцсети, подкаст, курсы и т.д.)",
    14: "Какие темы вызывают у вас наибольший отклик аудитории?",
    15: "Какие продукты или услуги вы предлагаете сейчас?",
    16: "Какие цели вы ставите на ближайшие 6-12 месяцев?",
    17: "Что бы вы хотели, чтобы люди говорили о вас как об эксперте?"
}
...
def handle_answer(conn, chat_id, telegram_id, text, current_step):
    ...
    if next_step <= 17:
        ...
        send_message(
            ...
            "Напишите /done чтобы получить вашу персональную распаковку экспертности."
        )
